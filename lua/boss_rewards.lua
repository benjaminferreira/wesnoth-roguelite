...
BR.rewards = {
    [1] = {
        ...
        amplifier = {
            ...
            {id="arcane_mastery", flavor="Your mages push the boundaries of what's possible. Their spells strike with devastating force.",
                label="Arcane Mastery", description="All magical attacks deal +2 damage per strike.",
                image="icons/book.png", target="auto", confirm="Magical damage increased by +2 per strike"},
            ...
            {id="blood_harvest", flavor="The battlefield teaches its own lessons. Every kill feeds the hunger.",
                label="Blood Harvest", description="Choose 3 units to gain Feeding. All Feeding units gain +3 max HP per kill instead of +1.",
